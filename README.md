...
gh release download v0.3.0 -R AartikSarma/synthetic_clif -p "synth_clif_10k.tar.gz"
mkdir -p synth_clif_10k && tar -xzf synth_clif_10k.tar.gz -C synth_clif_10k

# Or download directly
curl -L https://github.com/AartikSarma/synthetic_clif/releases/download/v0.3.0/synth_clif_10k.tar.gz | tar -xz -C synth_clif_10k
```
